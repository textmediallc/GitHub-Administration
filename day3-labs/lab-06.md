...
3. **Attempt to Add a Secret via the Web Editor:**
   ...
   * Add the line `AWS_SECRET_ACCESS_KEY=wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY` (another widely published example AWS credential, safe for this exercise).
...
7. **Remove the Secret:** Delete the flagged line from the file content in the editor.
